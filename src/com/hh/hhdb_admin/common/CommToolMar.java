...
public class CommToolMar {
	...
	static {
		LangMgr.merge(CommToolMar.class.getName(), LangUtil.loadLangRes(CommToolMar.class));
	}

	public List<String> genToolInfo() {
		List<String> toolInfolist = new ArrayList<String>();
		LoginBean lb;
		...
		if (lb.getViewType() == ViewType.USER && dbtype == DBTypeEnum.hhdb) {
	...
	public String genTitle(String key) {
		return LangMgr.getValue(CommToolMar.class.getName(), key);
	}
