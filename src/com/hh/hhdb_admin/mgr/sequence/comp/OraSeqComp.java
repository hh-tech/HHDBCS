...
import com.hh.frame.create_dbobj.sequenceMr.OracleSeqMr;
 ...
 * oracle数据库序列面板
 * @author HuBingBing
 * @date 2020年12月22日上午9:20:59
 */
public class OraSeqComp extends AbsSeqComp {
	...
	private OracleSeqMr smr;

	public OraSeqComp(String schema,String seqName, boolean isEdit) {
		this.schema=schema;
		this.seq=seqName;
		this.isEdit=isEdit;
