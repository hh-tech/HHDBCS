...
public class MainFrameCompTest {
	private static MainFrameComp mainFrameComp;
	...
	private static void showComp() {
		mainFrameComp = new MainFrameComp() {
			@Override
		...
		tabPane.addPanel("1", new HPanel(),new HeaderConfig("测试tab"));
		tabPane.addPanel("2", new HPanel(),new HeaderConfig("测试tab2"));
		tabPane.addPanel("3", new HPanel(),new HeaderConfig("测试tab3"));
