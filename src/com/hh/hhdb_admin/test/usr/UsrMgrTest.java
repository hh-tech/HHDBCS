...
public class UsrMgrTest {
    public static void main(String[] args) {
        try {
            ...
            String jStr=ClassLoadUtil.loadTextRes(UsrMgrTest.class, "conf.json");
            ...
            eng.doCall(CsMgrEnum.USR, GuiJsonUtil.toJsonCmd(UsrMgr.CMD_SET_TEST_CONN).add(UsrMgr.PARAM_TEST_CONN_ID,connId));
            SleepUtil.sleep1000();
