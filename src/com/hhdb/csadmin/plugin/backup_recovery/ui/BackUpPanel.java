 ...
 *
 */
public abstract class BackUpPanel extends JPanel implements ActionListener,BackUpAndRestore {
	...
	private JLabel tlabel11,tlabel21,tlabel31,tlabel41,tlabel61;
	public BackUpPanel(int width,int height){
		setLayout(new GridBagLayout());
		setPreferredSize(new Dimension(width,height));
		radio1 = new JRadioButton("结构及数据");// 创建单选按钮
		radio1.setSelected(true);
        radio2 = new JRadioButton("只结构");// 创建单选按钮
		...
		tab.add(radio1,new GridBagConstraints(0, 0, 1, 1, 1.0, 0.0, GridBagConstraints.NORTHWEST, GridBagConstraints.NONE, new Insets(5, 50, 0,0), 0, 0));
		tab.add(radio2,new GridBagConstraints(1, 0, 1, 1, 1.0, 0.0, GridBagConstraints.NORTHWEST, GridBagConstraints.NONE, new Insets(5, 10, 0,0), 0, 0));
		tab.add(jp,new GridBagConstraints(0, 1, 2, 1, 1.0, 0.0, GridBagConstraints.NORTHWEST, GridBagConstraints.NONE, new Insets(3, 5, 10,7), 0, 0));
		...
		tab1.add(tlabel3, new GridBagConstraints(1, 3, 1, 1, 1.0, 1.0, GridBagConstraints.NORTHWEST, GridBagConstraints.NONE, new Insets(5, 45, 0,0), 0, 0));
		tab1.add(tlabel4, new GridBagConstraints(1, 4, 1, 1, 1.0, 1.0, GridBagConstraints.NORTHWEST, GridBagConstraints.NONE, new Insets(5, 45, 0,0), 0, 0));
		tab1.add(tlabel6, new GridBagConstraints(1, 5, 1, 1, 1.0, 1.0, GridBagConstraints.NORTHWEST, GridBagConstraints.NONE, new Insets(5, 45, 0,0), 0, 0));
		...
		tab1.add(tlabel31, new GridBagConstraints(2, 3, 1, 1, 1.0, 1.0, GridBagConstraints.NORTHWEST, GridBagConstraints.NONE, new Insets(5, 70, 0,0), 0, 0));
		tab1.add(tlabel41, new GridBagConstraints(2, 4, 1, 1, 1.0, 1.0, GridBagConstraints.NORTHWEST, GridBagConstraints.NONE, new Insets(5, 70, 0,0), 0, 0));
		tab1.add(tlabel61, new GridBagConstraints(2, 5, 1, 1, 1.0, 1.0, GridBagConstraints.NORTHWEST, GridBagConstraints.NONE, new Insets(5, 70, 3,0), 0, 0));
	...
	public JLabel getTlabel31() {
		return tlabel31;
	}

	public void setTlabel31(String tlabel31) {
		this.tlabel31.setText(tlabel31);
	}
