 ...
 * 
 */
public class BackupSchemaPanel extends BackUpPanel implements ActionListener {
	...
	private BackupSchemaPanel bpanel;
	private Thread mainthred;
	public BackupSchemaPanel(HBackupRecovery bkr) {
		super(460, 405);
		this.bkr = bkr;
		bpanel = this;
		ok = new BaseButton("开始");
		cancle = new BaseButton("结束");
