package com.hhdb.csadmin.plugin.function.component.basetab;
...
public class BaseTabbedPane extends JPanel {
	 ...
	 * @return
	 */
	public void addTab(String title, Icon icon, final JComponent component, boolean closeAble, String tip,
			boolean moreopen) {
		addTab(title, icon, component, tip, closeAble, moreopen);
	}

	public void addTab(String title, Icon icon, final JComponent component, String tip, boolean closeAble,
			boolean moreopen) {
	...
	public void close(BaseTab tab) {
		...
		// QueryEditorMainPanel
		// sqlmain=(QueryEditorMainPanel)tab.getComponent();
