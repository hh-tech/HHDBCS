 ...
 * 进程监控CPU排序
 */
public class ProSeriesSortMem extends JPanel {
	...
	public ProSeriesSortMem(final DBMonitor monitorPlugin) {
	    ...
	    try{
	    	//查找事件
	        SqlBean sqlBean = HHSqlUtil.getSqlBean(ITEM_TYPE.DBSERVER,"show_ps_top_cpu");
