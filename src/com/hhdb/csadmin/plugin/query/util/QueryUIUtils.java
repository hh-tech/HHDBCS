...
public class QueryUIUtils {
	...
	public static void showWarningBox(JPanel jpanel,String message) {
		JOptionPane.showMessageDialog(jpanel, message, "提示", JOptionPane.WARNING_MESSAGE, null);
	}
	public static void showErrorBox(JPanel jpanel,String message) {
		if(message!=null&&!"".equals(message.trim())){
			JOptionPane.showMessageDialog(jpanel, message, "提示",JOptionPane.ERROR_MESSAGE); 
		}
	}
    ...
    /*public static void showWaitCursor(JPanel jpanel) {
        ThreadUtils.invokeAndWait(new Runnable() {
            public void run() {
                showWaitCursor(jpanel);
            }
        });
    }*/
    ...
    /*public static void showNormalCursor() {
        ThreadUtils.invokeAndWait(new Runnable() {
            public void run() {
                showNormalCursor(ApplicationLauncher.getFrame());
            }
        });
    }*/
}
