...
import com.hhdb.csadmin.plugin.table_operate.component.basetab.BaseTab;
...
public class BaseTabbedPaneCustom extends JTabbedPane implements MouseListener {
	...
	/*
	 * public JToolTip createToolTip() { ThumbnailToolTip tooltip = new
	 * ThumbnailToolTip(); tooltip.setComponent(this); return tooltip; }
	 */
	...
	private void showPopupMenu(final MouseEvent event) {
		...
		final int index = ((BaseTabbedPaneCustom) event.getComponent()).getUI().tabForCoordinate(this, event.getX(),
				event.getY());
